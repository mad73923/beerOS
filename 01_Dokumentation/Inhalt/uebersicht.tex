...
10101010_{2}$}\todo{canary wert? comment in file} %https://en.wikipedia.org/wiki/Buffer_overflow_protection#Canaries ist die gängige bezeichnung, sollten wir das nicht auch so nennen. 
...
schlafenden Tasks aufgeweckt\todo{verweis zeiten} werden. Im 
anderen Fall 
...
Zustand versetzt werden darf und ihre Priorität auf das Maximum\todo{maximum? niedrigste prio?}
...
\section{Collections}
Andy's Linked List is soooo geil \todo{mach hinne!}

\texttt{\#ToastGibtsSpäter}
...
vor allem in den Tests \todo{verweis} Anwendung.
