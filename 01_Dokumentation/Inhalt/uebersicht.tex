...
die Verwendung von Collections\todo{verweis}, welche Datenpakete hantierbar 
...
\begin{lstlisting}[language=C, label=lst:lst:listIter, caption=Iteratorfunktion der \texttt{LinkedList}]
int value;
...
Wenn möglich wurde die \texttt{Queue} im XX\todo{name?}OS verwendet.
