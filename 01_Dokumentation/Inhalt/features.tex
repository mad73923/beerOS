...
Eine Implentierung ohne ein \texttt{prev} wäre auch denkbar, also eine einfach verkettete Liste, \todo{wortsalat} es vereinfacht aber das entfernen eines MemoryHeads aus der List wenn ein Speicherbereich freigegeben wird.
